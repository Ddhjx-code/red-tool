...
(function () {
  ...
  var displayFrag = [
    ...
    '     不是装饰，绝不盖住用户画的纹样。 */',
    '  float ribN = 6.0 + 2.0 * (uShapeW.z + uShapeW.w);',
    '  float ribA = 0.14 + 0.06 * uShapeW.z;',
    ...
    '  float lamp = (0.52 + 0.48 * exp(-fr * fr * 1.30)) * flick;',
    '  lamp *= 0.86 + 0.20 * (1.0 - smoothstep(-1.10, 0.90, fd.y));   /* 靠烛火处更热 */',
    '  lamp += uFlash;',
    ...
    '',
    '  /* 竹篾：受光的竖向骨条（像素阶跃，随灯体转，见上） */',
    '  lit += LAMP * rib * ribA * lamp;',
    '  lit *= 1.0 - rib * cover * 0.10;',
    '',
